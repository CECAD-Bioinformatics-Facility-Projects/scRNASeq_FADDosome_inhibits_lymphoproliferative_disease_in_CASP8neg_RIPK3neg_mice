...
# Knit relative to project root so renv/activate.R is found and paths are consistent
...
so.split <- qs::qread("data/demo_seurat_objects.combined.cleansed.annotated.250428.qs")
...
cat(sprintf("Total run time: %.2f %s\n", as.numeric(runtime), attr(runtime, "units")))
