...
seurat_objects.combined@version
ncol(seurat_objects.combined)
```


```{r}
so <- qs::qread("data/seurat_objects.combined.cleansed.annotated.250428.qs")
...
so.dbl <- qs::qread("data/seurat_objects.combined.clusterin.doublet_info.qs")



curr.dbl <- qs::qread("results/seurat_objects.combined.clusterin.doublet_info.qs")

ncol(seurat_objects.combined)
ncol(so)
table(so.dbl$scDblFinder.class)
table(curr.dbl$scDblFinder.class)
